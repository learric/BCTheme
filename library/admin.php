...
function bones_custom_dashboard_widgets() {
	//wp_add_dashboard_widget( 'lm_custom_widget', 'This is a custom widget', 'bonestheme' );
	/*
...
function bones_custom_admin_footer() {
	_e( '<span id="footer-thankyou">Developed by <a href="http://learricmedia.com" target="_blank">Learric Media, LLC</a></span>', 'bonestheme' );
}
